    ...
    if bool(_cfg_get(sparse_cfg, "ENABLED", False)):
        modules.append(
            SparsePointRegularizationLoss(
                ...
                loss_support_use_brightness=bool(_cfg_get(sparse_cfg, "LOSS_SUPPORT_USE_BRIGHTNESS", True)),
                loss_support_use_gradient=bool(_cfg_get(sparse_cfg, "LOSS_SUPPORT_USE_GRADIENT", True)),
                prune_support_use_brightness=bool(_cfg_get(sparse_cfg, "PRUNE_SUPPORT_USE_BRIGHTNESS", True)),
                prune_support_use_gradient=bool(_cfg_get(sparse_cfg, "PRUNE_SUPPORT_USE_GRADIENT", True)),
                ...
                mid_hard_candidate_subset_min=_cfg_get(sparse_cfg, "MID_HARD_CANDIDATE_SUBSET_MIN", None),
                mid_hard_candidate_subset_max=_cfg_get(sparse_cfg, "MID_HARD_CANDIDATE_SUBSET_MAX", None),
